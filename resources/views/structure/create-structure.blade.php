<x-layout>
    <x-slot:title>
        Form Tambah Struktur Prejuru Desa
    </x-slot>
    ...
    <div class="form-container">
        <form class="form-card" action="{{route('structure.store')}}" method="POST" enctype="multipart/form-data">
            @csrf

            <h2>Form Tambah Struktur Prejuru Desa</h2>
            ...
            <input type="text" name="position_id" id="position_id" placeholder="Isi id untuk prejuru baru"> <br>
