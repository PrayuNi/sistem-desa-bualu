  ...
  <!-- Konten -->
    ...
    <section class="content h-fit container mx-auto py-7">
      ...
      >
        ...
        <p>Jumlah ini menunjukkan total penduduk pendatang (Krama Tamiu) yang tinggal di Desa Adat Bualu dan terdaftar sebagai warga di wilayah Desa Adat Bualu.</p>
      </div>
      <!-- End Title -->
