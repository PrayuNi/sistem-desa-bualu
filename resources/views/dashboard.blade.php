        ...
        >
          <div class="bg-white rounded-lg p-6 max-w-sm w-full relative">
            ...
            <form action="" method="post">
              ...
              <div class="input-group mt-3 font-bold">
                <label for="input-belanja">Belanja</label>
                <input
                  class="border-2 border-gray-500 w-full rounded-xl p-3"
                  type="number"
                  name="input-belanja"
              ...
              <div class="input-group mt-3 font-bold">
                <label for="input-pengeluaran">Pengeluaran</label>
                <input
                  class="border-2 border-gray-500 w-full rounded-xl p-3"
                  type="number"
              ...
              <div class="input-group mt-3 font-bold">
                <label for="input-surplus">Surplus/Defisit</label>
                <input
                  class="border-2 border-gray-500 w-full rounded-xl p-3"
                  type="number"
                  name="input-surplus"
                  id="input-surplus"
                  placeholder="Masukkan Jumlah Surplus/Defisit"
                />
              </div>

              <div class="input-group mt-3 font-bold">
                <label for="input-file">File Data APBD</label>
                <input
                  class="border-2 border-gray-500 w-full rounded-xl p-3"
                  type="file"
                  name="input-file"
            ...
            <div class="mt-4 flex justify-end space-x-2">
              <button
                id="closemodalsummary"
                class="bg-gray-300 rounded px-3 py-1 hover:bg-gray-400"
              >
                Tutup
              </button>
              <button
